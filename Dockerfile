# Generated by precisionFDA exporter (v1.0.3) on 2018-06-25 22:50:38 +0000
...
# Download app assets
RUN curl https://dl.dnanex.us/F/D/x6ZkpbPj4fpqZBqkK26jF6Q6Jz4YzYxjkbzXPPB5/samtools-1.3.tar.gz | tar xzf - -C / --no-same-owner --no-same-permissions
